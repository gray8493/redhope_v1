                    ...
                    <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                        ...
                        <div className="flex py-1">
                            <div className="grid grid-cols-3 gap-1 w-full p-1 bg-gray-100 rounded-xl">
                                {/* Radio inputs are hidden visually but functional logic would go here. For UI demo we use buttons/labels */}
                        ...
                        <form action="#" className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between">
                                    ...
                                    <a className="text-sm font-semibold text-primary hover:underline" href="#">Quên mật khẩu?</a>
                                </div>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="text-center text-sm text-gray-500">
                            Chưa có tài khoản?{' '}
                            <a className="font-bold text-primary hover:underline hover:text-primary-dark" href="register">
                                Tạo tài khoản mới
                            </a>
                        </p>
                    </div>
