...
import { Loader2, X, Calendar, MapPin, Droplet, Star } from 'lucide-react';
                        ...
                        recentDonors.map((donor) => (
                            <div key={donor.id} className="flex items-center gap-4 py-3 border-b border-gray-50 last:border-0">
                                ...
                                <button
                                    ...
                                    className="text-xs font-semibold text-[#6324eb] hover:bg-purple-50 px-3 py-1.5 rounded-lg transition-colors"
                                >
                                    Chi tiết
                                </button>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100">
                        ...
                        <div className="relative h-32 bg-gradient-to-br from-[#6324eb] to-[#925eff] overflow-hidden">
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 p-2 bg-white/20 hover:bg-white/30 text-white rounded-full transition-all backdrop-blur-md shadow-sm group border border-white/10"
                            >
                        ...
                        <div className="px-6 pb-8 relative">
                            ...
                            <div className="flex flex-col items-center -mt-12 mb-4">
                                <div className="p-1.5 bg-white rounded-full shadow-xl relative z-10">
                                    <div className="size-24 rounded-full bg-gradient-to-br from-[#f3f0ff] to-[#e6dbff] flex items-center justify-center text-3xl font-bold text-[#6324eb] uppercase shadow-inner border border-purple-100">
                                ...
                                <div className="flex gap-3 mt-5">
                                    <div className={`px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-sm border transition-transform hover:scale-105 ${selectedDonor.blood_group
                                    ...
                                    <div className="px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 bg-amber-50 text-amber-700 border border-amber-100 shadow-sm transition-transform hover:scale-105">
                            ...
                            <div className="space-y-3 mt-4">
                                <div className="flex items-center gap-4 p-4 bg-gray-50/80 rounded-2xl border border-gray-100 hover:border-purple-200 hover:bg-purple-50/50 transition-all group cursor-default">
                            ...
                            <div className="mt-8">
                                <Link
                                    href="/admin/admin-donor"
                                    className="block w-full py-3.5 px-4 bg-gradient-to-r from-[#6324eb] to-[#501ac2] hover:from-[#501ac2] hover:to-[#3e149c] text-white text-sm font-bold text-center rounded-xl shadow-lg shadow-purple-200 hover:shadow-purple-300 transition-all transform hover:-translate-y-0.5 active:scale-[0.98]"
                                >
                                    Xem quản lý đầy đủ
                                </Link>
                            </div>
