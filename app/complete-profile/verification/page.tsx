                        ...
                        <div className="p-8">
                            <form className="flex flex-col gap-8">
                                ...
                                <div className="flex items-center justify-between pt-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex items-center gap-2 px-8 py-3 rounded-lg bg-[#2b6cee] hover:bg-[#2b6cee]/90 text-white font-bold text-sm shadow-lg shadow-[#2b6cee]/30 transition-transform active:scale-95"
                                    >
                                        Hoàn tất đăng ký
