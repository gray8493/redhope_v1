                                            ...
                                            <div className="grid grid-cols-4 sm:grid-cols-8 gap-2">
                                                {['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'].map((type) => (
                                                    <button
                                                        ...
                                                        className={`flex h-12 items-center justify-center rounded-lg font-bold transition-all border-2 ${type === bloodType
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="flex p-1 bg-slate-100 dark:bg-[#251e36] rounded-xl h-12">
                                                    <button
                                                        ...
                                                        className={`flex-1 rounded-lg text-sm font-bold transition-all ${urgency === 'standard'
                                                                ? 'bg-white dark:bg-[#1c162e] shadow-sm text-[#6324eb] dark:text-white border border-slate-200 dark:border-slate-700'
                                                                : 'text-slate-500 hover:text-[#6324eb]'
                                                            }`}
                                                    >
                                                        Tiêu chuẩn
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`flex-1 rounded-lg text-sm font-bold transition-all ${urgency === 'urgent'
