                        ...
                        <div className="flex flex-col max-w-[1400px] flex-1 px-4 md:px-8 space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="flex items-center gap-2 text-slate-500 bg-white dark:bg-[#1c162e] p-1 rounded-lg border border-[#ebe7f3] dark:border-[#2d263d] w-fit">
                                    <button className="px-4 py-2 bg-slate-100 dark:bg-[#251e36] text-[#120e1b] dark:text-white rounded-md font-bold text-sm shadow-sm">Tháng này</button>
                                    <button className="px-4 py-2 hover:bg-slate-50 text-slate-600 rounded-md font-medium text-sm transition-colors">Quý này</button>
                                    <button className="px-4 py-2 hover:bg-slate-50 text-slate-600 rounded-md font-medium text-sm transition-colors">Năm nay</button>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white dark:bg-[#1c162e] p-6 rounded-2xl border border-[#ebe7f3] dark:border-[#2d263d] shadow-sm">
                                    ...
                                    <div className="flex items-end gap-3">
                                        <h3 className="text-3xl font-black text-[#120e1b] dark:text-white">845</h3>
                                        <span className="text-xs font-bold text-green-600 mb-1 flex items-center gap-0.5 bg-green-50 px-1.5 py-0.5 rounded">
                                            <ArrowUpRight className="w-3 h-3" /> +12.5%
                                        </span>
                                    </div>
                                    <p className="text-xs text-slate-400 mt-2">So với tháng trước (751)</p>
                                </div>
                                ...
                                <div className="bg-white dark:bg-[#1c162e] p-6 rounded-2xl border border-[#ebe7f3] dark:border-[#2d263d] shadow-sm">
                                    ...
                                    <div className="flex items-end gap-3">
                                        <h3 className="text-3xl font-black text-[#120e1b] dark:text-white">620</h3>
                                        <span className="text-xs font-bold text-green-600 mb-1 flex items-center gap-0.5 bg-green-50 px-1.5 py-0.5 rounded">
                                ...
                                <div className="bg-white dark:bg-[#1c162e] p-6 rounded-2xl border border-[#ebe7f3] dark:border-[#2d263d] shadow-sm">
                                    ...
                                    <p className="text-xs text-slate-400 mt-2">Thấp hơn mức trung bình (25)</p>
                                </div>
                            </div>
