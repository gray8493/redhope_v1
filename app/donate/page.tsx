                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <main className="flex flex-1 justify-center py-8">
                        <div className="flex flex-col max-w-[1200px] flex-1 px-4 md:px-10">
                            ...
                            {/* Hero Section */}
                            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-10 bg-gradient-to-r from-[#7f1d1d] to-[#991b1b] rounded-2xl p-8 text-white shadow-xl shadow-[#991b1b]/20 relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="lg:col-span-2 flex flex-col gap-6">
                                    <div className="bg-white dark:bg-[#2a1a1a] rounded-xl border border-red-100 dark:border-red-900/30 p-6 shadow-sm">
                                        <h2 className="text-xl font-bold mb-6 flex items-center gap-2 text-[#7f1d1d] dark:text-red-400">
                                            <Wallet className="w-6 h-6" /> Quyên góp ngay
                                        </h2>

                                        <div className="flex flex-col gap-6">
                                            <div>
                                                <label className="block text-sm font-bold text-[#991b1b] dark:text-red-400 mb-3 uppercase tracking-wider">Chọn mức đóng góp</label>
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                                    <button className="py-3 px-4 rounded-lg border-2 border-red-100 dark:border-red-900/30 hover:border-[#991b1b] hover:bg-[#991b1b]/5 hover:text-[#991b1b] font-bold transition-all text-[#7f1d1d] dark:text-red-200">
                                                        50.000đ
                                                    </button>
                                                    <button className="py-3 px-4 rounded-lg bg-[#991b1b] text-white border-2 border-[#991b1b] font-bold transition-all shadow-lg shadow-[#991b1b]/30 transform hover:scale-105">
                                                        100.000đ
                                                    </button>
                                                    <button className="py-3 px-4 rounded-lg border-2 border-red-100 dark:border-red-900/30 hover:border-[#991b1b] hover:bg-[#991b1b]/5 hover:text-[#991b1b] font-bold transition-all text-[#7f1d1d] dark:text-red-200">
                                                        200.000đ
                                            ...
                                            <div>
                                                <label className="block text-sm font-bold text-[#991b1b] dark:text-red-400 mb-3 uppercase tracking-wider">Hoặc nhập số tiền khác</label>
                                                <div className="relative">
                                                    <input
                                                        type="text"
                                                        className="w-full bg-[#fef2f2] dark:bg-[#1f1212] border-none rounded-xl py-4 px-4 text-xl font-bold text-[#450a0a] dark:text-white focus:ring-2 focus:ring-[#991b1b] placeholder:text-red-300"
                                                        placeholder="Nhập số tiền (VNĐ)"
                                                    />
                                                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#991b1b] font-bold">VNĐ</span>
                                                </div>
                                            </div>

                                            <div>
                                                <label className="block text-sm font-bold text-[#991b1b] dark:text-red-400 mb-3 uppercase tracking-wider">Phương thức thanh toán</label>
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <button className="flex items-center gap-4 p-4 rounded-xl border border-red-100 dark:border-red-900/30 hover:border-[#991b1b] bg-white dark:bg-[#2a1a1a] transition-all group text-left hover:shadow-md hover:shadow-red-900/5">
                                                        ...
                                                        <div>
                                                            <p className="font-bold text-[#450a0a] dark:text-white group-hover:text-[#991b1b] transition-colors">Ví MoMo</p>
                                                    ...
                                                    <button className="flex items-center gap-4 p-4 rounded-xl border border-red-100 dark:border-red-900/30 hover:border-[#991b1b] bg-white dark:bg-[#2a1a1a] transition-all group text-left hover:shadow-md hover:shadow-red-900/5">
                                                        ...
                                                        <div>
                                                            <p className="font-bold text-[#450a0a] dark:text-white group-hover:text-[#991b1b] transition-colors">Thẻ Ngân hàng / Visa</p>
                                            ...
                                            <button className="w-full py-4 bg-[#991b1b] hover:bg-[#7f1d1d] text-white text-lg font-black rounded-xl shadow-xl shadow-[#991b1b]/20 transition-all active:scale-[0.98] mt-2 ring-offset-2 focus:ring-2 ring-[#991b1b]">
                                                Tiến hành Quyên góp
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white dark:bg-[#2a1a1a] rounded-xl border border-red-100 dark:border-red-900/30 p-6 shadow-sm">
                                        <h3 className="font-bold text-lg mb-4 text-[#7f1d1d] dark:text-red-100">Hoạt động gần đây</h3>
                                            ...
                                            {[1, 2, 3].map((_, i) => (
                                                <div key={i} className="flex items-center justify-between pb-4 border-b border-red-100 dark:border-red-900/20 last:border-0 last:pb-0">
                                                    <div className="flex items-center gap-3">
                                                        <div className="size-8 rounded-full bg-red-50 dark:bg-red-900/20 flex items-center justify-center font-bold text-xs text-[#991b1b]">
                                                            ND
                                                        </div>
                                                        <div>
                                ...
                                <div className="lg:col-span-1 flex flex-col gap-6">
                                    <div className="bg-white dark:bg-[#2a1a1a] rounded-xl border border-red-100 dark:border-red-900/30 p-0 shadow-sm overflow-hidden flex flex-col h-full max-h-[800px]">
                                        <div className="p-6 pb-4 border-b border-red-100 dark:border-red-900/30 bg-gradient-to-r from-red-50 to-white dark:from-[#2a1a1a] dark:to-[#1f1212]">
                                            <h2 className="text-xl font-bold flex items-center gap-2 text-[#b91c1c]">
                                        ...
                                        <div className="flex-1 overflow-y-auto">
                                            ...
                                            <div className="p-4 flex items-center gap-4 bg-red-50 dark:bg-red-900/10 border-b border-red-100 dark:border-red-900/30">
                                                <div className="flex-none font-black text-2xl text-[#b91c1c] w-8 text-center drop-shadow-sm">1</div>
                                                <div className="size-12 rounded-full border-2 border-[#b91c1c] p-0.5">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-sm font-black text-[#991b1b]">150tr</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-4 flex items-center gap-4 border-b border-red-100 dark:border-red-900/30">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-sm font-black text-[#991b1b]">85tr</p>
                                                </div>
                                            </div>

                                            {/* Top 3 */}
                                            <div className="p-4 flex items-center gap-4 border-b border-red-100 dark:border-red-900/30">
                                                <div className="flex-none font-black text-xl text-[#7f1d1d] w-8 text-center">3</div>
                                                <div className="size-10 rounded-full border-2 border-[#7f1d1d] p-0.5">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-sm font-black text-[#991b1b]">50tr</p>
                                                </div>
                                            </div>
                                            ...
                                            {[4, 5, 6, 7].map((rank) => (
                                                <div key={rank} className="p-4 flex items-center gap-4 border-b border-red-100 dark:border-red-900/30 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors">
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-sm font-bold text-[#991b1b]">10tr</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <div className="p-4 bg-red-50 dark:bg-[#251e36] text-center border-t border-red-100 dark:border-red-900/30">
                                            <button className="text-sm font-bold text-[#991b1b] hover:underline">Xem tất cả bảng xếp hạng</button>
                                        </div>
                                    </div>

                                    {/* Motivation Card */}
                                    <div className="bg-gradient-to-br from-[#991b1b] to-[#7f1d1d] rounded-xl p-6 text-white shadow-lg relative overflow-hidden">
                                        ...
                                        <button className="bg-white text-[#991b1b] font-bold py-2 px-4 rounded-lg text-sm w-full hover:bg-red-50 transition-colors">
                                            Tìm hiểu thêm
                                        </button>
                                    </div>
                                </div>
