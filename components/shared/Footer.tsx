...
const Footer = () => {
    return (
        <footer className="bg-white pt-12 md:pt-20 pb-10 border-t border-slate-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="border-t border-slate-300 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 text-center md:text-left">
