...
export const AdminSidebar = () => {
    ...
    const menuItems = [
        ...
        { href: '/admin-donor', icon: 'person', label: 'Quản lý người hiến' },
        { href: '/campaign-management', icon: 'campaign', label: 'Quản lý chiến dịch' },
        { href: '/admin-hospitals', icon: 'domain', label: 'Bệnh viện' },
        { href: '/voucher-management', icon: 'confirmation_number', label: 'Quản lý Voucher' },
        { href: '/global-ana', icon: 'analytics', label: 'Phân tích toàn cầu' },
