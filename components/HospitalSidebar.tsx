            ...
            <aside className="fixed left-0 top-0 w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col justify-between p-4 h-screen z-40 hidden md:flex transition-all duration-300">
                <div className="flex flex-col gap-8">
                    ...
                    <nav className="flex flex-col gap-2">
                        <Link href="/hospital" className="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-[#6324eb] dark:hover:text-[#6324eb] rounded-xl transition-all font-medium">
                            <LayoutDashboard className="w-5 h-5" />
                            <p className="text-sm">Bảng điều khiển</p>
                        </Link>
                        <Link href="/hospital/requests/create" className="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-[#6324eb] dark:hover:text-[#6324eb] rounded-xl transition-all font-medium">
